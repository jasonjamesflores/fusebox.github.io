...
<cfset myFusebox.thisFuseaction = "delete_subjects">
<cftry>
<cfoutput><cfinclude template="../model/subjects/act_delete_subjects.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 23 and right(cfcatch.MissingFileName,23) is "act_delete_subjects.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_delete_subjects.cfm in circuit m_subject which does not exist (from fuseaction m_subject.delete_subjects).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
