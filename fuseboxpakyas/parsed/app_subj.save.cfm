...
<cfset myFusebox.thisFuseaction = "save_subjects">
<cftry>
<cfoutput><cfinclude template="../model/subjects/act_save_subjects.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 21 and right(cfcatch.MissingFileName,21) is "act_save_subjects.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_save_subjects.cfm in circuit m_subject which does not exist (from fuseaction m_subject.save_subjects).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
