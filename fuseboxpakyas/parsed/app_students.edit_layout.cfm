...
<cfset myFusebox.thisCircuit = "m_students">
<cfset myFusebox.thisFuseaction = "get_students_id">
<cftry>
<cfoutput><cfinclude template="../model/students/act_get_students_by_id.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 26 and right(cfcatch.MissingFileName,26) is "act_get_students_by_id.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_get_students_by_id.cfm in circuit m_students which does not exist (from fuseaction m_students.get_students_id).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="m_course.get_course" --->
<cfset myFusebox.thisCircuit = "m_course">
<cfset myFusebox.thisFuseaction = "get_course">
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_get_course.cfm in circuit m_course which does not exist (from fuseaction m_course.get_course).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="students_display.header_edit_students" --->
<cfset myFusebox.thisCircuit = "students_display">
<cfset myFusebox.thisFuseaction = "header_edit_students">
<cfsavecontent variable="header_content">
<cftry>
<cfoutput><cfinclude template="../view/students/dsp_edit_header.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_edit_header.cfm in circuit students_display which does not exist (from fuseaction students_display.header_edit_students).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
<!--- do action="students_display.body_edit_students" --->
<cfset myFusebox.thisFuseaction = "body_edit_students">
<cfsavecontent variable="body_content">
<cftry>
<cfoutput><cfinclude template="../view/students/dsp_edit_body.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_edit_body.cfm in circuit students_display which does not exist (from fuseaction students_display.body_edit_students).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
