...
<cfset myFusebox.thisFuseaction = "get_subjects_id">
<cftry>
<cfoutput><cfinclude template="../model/subjects/act_get_subjects_by_id.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 26 and right(cfcatch.MissingFileName,26) is "act_get_subjects_by_id.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_get_subjects_by_id.cfm in circuit m_subject which does not exist (from fuseaction m_subject.get_subjects_id).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="subj_display.header_edit_subject" --->
<cfset myFusebox.thisCircuit = "subj_display">
<cfset myFusebox.thisFuseaction = "header_edit_subject">
<cfsavecontent variable="header_content">
<cftry>
<cfoutput><cfinclude template="../view/subjects/dsp_edit_header.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_edit_header.cfm in circuit subj_display which does not exist (from fuseaction subj_display.header_edit_subject).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
<!--- do action="subj_display.body_edit_subject" --->
<cfset myFusebox.thisFuseaction = "body_edit_subject">
<cfsavecontent variable="body_content">
<cftry>
<cfoutput><cfinclude template="../view/subjects/dsp_edit_body.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_edit_body.cfm in circuit subj_display which does not exist (from fuseaction subj_display.body_edit_subject).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
