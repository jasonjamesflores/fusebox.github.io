...
<cfset myFusebox.thisCircuit = "m_students">
<cfset myFusebox.thisFuseaction = "delete_students">
<cftry>
<cfoutput><cfinclude template="../model/students/act_delete_students.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 23 and right(cfcatch.MissingFileName,23) is "act_delete_students.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_delete_students.cfm in circuit m_students which does not exist (from fuseaction m_students.delete_students).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
