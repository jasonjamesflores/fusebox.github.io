...
<cftry>
<cfoutput><cfinclude template="../model/teacher/act_update_teachers.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 23 and right(cfcatch.MissingFileName,23) is "act_update_teachers.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_update_teachers.cfm in circuit m_teacher which does not exist (from fuseaction m_teacher.update_teacher).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
