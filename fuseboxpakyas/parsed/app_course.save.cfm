...
<cfset myFusebox.thisFuseaction = "save_course">
<cftry>
<cfoutput><cfinclude template="../model/course/act_save_course.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "act_save_course.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_save_course.cfm in circuit m_course which does not exist (from fuseaction m_course.save_course).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
