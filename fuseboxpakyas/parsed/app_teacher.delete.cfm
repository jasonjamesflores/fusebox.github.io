...
<cftry>
<cfoutput><cfinclude template="../model/teacher/act_delete_teacher.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 22 and right(cfcatch.MissingFileName,22) is "act_delete_teacher.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_delete_teacher.cfm in circuit m_teacher which does not exist (from fuseaction m_teacher.delete_teacher).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
