...
<cftry>
<cfoutput><cfinclude template="../model/course/act_delete_course.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 21 and right(cfcatch.MissingFileName,21) is "act_delete_course.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_delete_course.cfm in circuit m_course which does not exist (from fuseaction m_course.delete_course).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
